...
/* package */class UploadHandler extends Handler
{
     ...
     * Localytics session
     */
    protected LocalyticsSession mSession;
     ...
     */
	/* package */private boolean uploadSessions(final String url, final String body, final String installId, final String apiKey)
    {
        ...
        else
        {
            ...
            try
            {
                ...
                if (null != entry) 
                {	                
	                retriveHttpResponse(entry.getContent());	                               
                }                                                             
            }
            catch (final UnsupportedEncodingException e)
            {
     ...
     */
	/* package */private void retriveHttpResponse(final InputStream input) throws IOException
	{
