...
/* package */class SessionHandler extends Handler
{
     ...
     * <p>
     * {@link Message#obj} is a string representing the amp display event type.
     */
    public static final int MESSAGE_TRIGGER_AMP = 12;
    ...
    {
    	return new UploadHandler(context, this, apiKey, getInstallationId(mProvider, apiKey), sUploadHandlerThread.getLooper());
    }
    ...
    /* package */void init()
    {
         ...
         */
        mUploadHandler = createUploadHandler(mContext, this, mApiKey, getInstallationId(mProvider, mApiKey), sUploadHandlerThread.getLooper());
    }
